...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-schnittwerk-900 text-white hover:bg-schnittwerk-800 active:scale-95",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border-2 border-schnittwerk-200 bg-transparent hover:bg-schnittwerk-50 hover:border-schnittwerk-300",
        secondary:
          "bg-gold-500 text-white hover:bg-gold-600 active:scale-95",
        ghost: "hover:bg-schnittwerk-100 hover:text-schnittwerk-900",
        link: "text-schnittwerk-900 underline-offset-4 hover:underline",
      },
      size: {
